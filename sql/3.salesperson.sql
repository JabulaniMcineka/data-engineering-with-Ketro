/*
=======================================================
Script: 3.dim_salesperson.sql
Description: Creates and populates dim_salesperson table
Purpose: Store sales employee information
...
CREATE TABLE [PC_Sales_Staging_dtw].[dbo].[dim_salesperson] (
...
INSERT INTO [PC_Sales_Staging_dtw].[dbo].[dim_salesperson] (
    [Employee_Sales],
    [Department],
    [Total_Sales]
)
