/*
=======================================================
Script: 2.dim_product.sql
Description: Creates and populates dim_product table
...
IF OBJECT_ID('[PC_Sales_Staging_dtw].[dbo].[dim_product]', 'U') IS NOT NULL
    DROP TABLE [PC_Sales_Staging_dtw].[dbo].[dim_product];

CREATE TABLE [PC_Sales_Staging_dtw].[dbo].[dim_product] (
...
INSERT INTO [PC_Sales_Staging_dtw].[dbo].[dim_product] (
    [PC_Name],
    [PC_Make],
    [PC_Model],
    [Storage_Capacity],
